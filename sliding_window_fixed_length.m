function [sliding_window_data, sliding_window_tiempo] = sliding_window_fixed_length(data, fs, t_window, step, estimulo_length)
...
% estimulo_length = tamaño del estímulo auditivo(en segundos)


% Calculo el tamaño final de: sliding_window_data y sliding_window_tiempo
tf = t_window;
n = 0;
limite = estimulo_length;
