...
%
% Devuelve el struct t0s_dict modificado. Les agrega los campos:
% 
% t0s_dict(i).spikes_norm = el tiempo (en samples) en que ocurren los 
% spikes "normalizados" al comienzo del estimulo
% 
% t0s_dict(i).trials_id = para cada spike se guarda el numero de trial en 
% el que ocurrio
